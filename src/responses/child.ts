...
export const childSchema = {
    os: {
        '1': schema.extend({
            albumArtists: artistId3RelatedSchema.ss['1.16.1'].array().optional(),
            artists: artistId3RelatedSchema.ss['1.16.1'].array().optional(),
            bitDepth: z.number().optional(),
            bpm: z.number().optional(),
            channelCount: z.number().optional(),
            comment: z.string().optional(),
            contributors: contributorSchema.os['1'].array().optional(),
            ...
            replayGain: replayGainSchema.os['1'].optional(),
